...
const EditPage = () => {
  ...
  const getProduct = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get(`https://node-api-v2-2exu.onrender.com/api/products/${id}`);
      setProduct({
  ...
  const updateProduct = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`https://node-api-v2-2exu.onrender.com/api/products/${id}`, product);
